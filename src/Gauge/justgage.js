...
JustGage = function(config) {
  ...
  obj.config = {
    ...
    titleFontColor: kvLookup('titleFontColor', config, dataset, "#000000"),
    ...
    labelFontColor: kvLookup('labelFontColor', config, dataset, "#2D1E2F"),
    ...
    startAnimationType: kvLookup('startAnimationType', config, dataset, 'bounce'),
    ...
    refreshAnimationType: kvLookup('refreshAnimationType', config, dataset, 'bounce'),
